          ...
          () => Container(
            ...
            child: Center(
              child: DropdownButton<String>(
                ...
                onChanged: (newValue) {
                  controller.updateSelectedDifficuilty(newValue.toString());
                },
                ...
                items: controller.difficuiltyLevelList
                ...
                value: controller.selectedDifficuilty.value == " "
                    ? null
                    : controller.selectedDifficuilty.value,
                underline: Container(
