...
import 'package:toast/features/user/social/screens/Recipe_view/directions_view/d_directions_view_body.dart';
import 'package:toast/features/user/social/screens/Recipe_view/ingredients_view/d_ingredients_header.dart';
import 'package:toast/utils/constants/sizes.dart';



class ScnDetailedDirectionsView extends StatelessWidget {
  ScnDetailedDirectionsView({
    super.key,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ViewDirectionBody(allDirections: allDirections)
            ],
          ),
        ),
      ),
