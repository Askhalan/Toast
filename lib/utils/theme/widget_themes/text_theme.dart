...
class JTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    headlineLarge: const TextStyle().copyWith(fontSize: 32.0, fontWeight: FontWeight.bold, color: JColor.dark),
    ...
    labelSmall: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.normal, color: JColor.dark),
    labelMedium: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.normal, color: JColor.dark),
    labelLarge: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.normal, color: JColor.dark),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    labelLarge: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.normal, color: JColor.light),
    labelMedium: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.normal, color: JColor.light),
    labelSmall: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.normal, color: JColor.light),);
}
