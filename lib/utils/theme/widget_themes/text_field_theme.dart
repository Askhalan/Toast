...
class JTextFormFieldTheme {
  ...
  static InputDecorationTheme lightInputDecorationTheme = InputDecorationTheme(
    ...
    labelStyle: const TextStyle().copyWith(fontSize: JmSize.fontSizeMd, color: JColor.black),
    hintStyle: const TextStyle().copyWith(fontSize: JmSize.fontSizeSm, color: JColor.black),
    errorStyle: const TextStyle().copyWith(fontStyle: FontStyle.normal),
    floatingLabelStyle: const TextStyle().copyWith(color: JColor.black.withOpacity(0.8)),
  ...
  static InputDecorationTheme darkInputDecorationTheme = InputDecorationTheme(
    ...
    suffixIconColor: JColor.darkGrey,
    // constraints: const BoxConstraints.expand(height: TSizes.inputFieldHeight),
    labelStyle: const TextStyle().copyWith(fontSize: JmSize.fontSizeMd, color: JColor.white),
    hintStyle: const TextStyle().copyWith(fontSize: JmSize.fontSizeSm, color: JColor.white),
    floatingLabelStyle: const TextStyle().copyWith(color: JColor.white.withOpacity(0.8)),
    border: const OutlineInputBorder().copyWith(
      borderRadius: BorderRadius.circular(JmSize.inputFieldRadius),
