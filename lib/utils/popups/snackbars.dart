...
class JMessages {
      ...
      SnackBar(
        ...
        content: Container(
          ...
          decoration: BoxDecoration(
            color: JHelperFunctions.isDarkMode(Get.context!) ? JColor.darkerGrey.withOpacity(0.9) : JColor.grey.withOpacity(0.9),
  ...
  static snackbarSuccess({required title, message = ''}){
    ...
    icon: const Icon(Icons.done_all,color: JColor.white,)
  ...
  static snackbarWarning({required title, message = ''}){
    ...
    duration: const Duration(seconds: 3),
    margin: const EdgeInsets.all(20),
    icon: const Icon(Icons.warning_amber_outlined,color: JColor.white,)
  ...
  static snackbarerror({required title, message = ''}){
    ...
    duration: const Duration(seconds: 3),
    margin: const EdgeInsets.all(20),
    icon: const Icon(Icons.error_outline,color: JColor.white,)
